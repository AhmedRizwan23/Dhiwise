...
import 'models/eightysix_item_model.dart';
...
import 'package:ahmed_s_application2/widgets/app_bar/appbar_subtitle_one.dart';
import 'package:ahmed_s_application2/widgets/app_bar/appbar_trailing_image.dart';
                              ...
                              Obx(() => Container(
                                  ...
                                  child: AnimatedSmoothIndicator(
                                      ...
                                      count: controller.dashboardModelObj.value
                                          .eightysixItemList.value.length,
    ...
    return Padding(
        ...
        child: Obx(() => CarouselSlider.builder(
            ...
            itemCount: controller
                .dashboardModelObj.value.eightysixItemList.value.length,
            itemBuilder: (context, index, realIndex) {
              EightysixItemModel model = controller
                  .dashboardModelObj.value.eightysixItemList.value[index];
              return EightysixItemWidget(model);
            })));
  }
